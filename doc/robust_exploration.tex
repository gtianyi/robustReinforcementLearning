...
\begin{figure}
	\begin{center}
		...
		(q4)  edge [bend left=20]  node[el,left, rotate=-90, font=\fontsize{2}{2.5}\selectfont]  {$(3,1,0)$\\$(1,0.4,198)$}        (q0)
		...
		(q3)  edge [in=10,out=350,loop] node[el,above, rotate=-90, font=\fontsize{2}{2.5}\selectfont] {$(3,1,0)$}   (q3)
